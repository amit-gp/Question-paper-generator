...
class Ui_GeneratorMainWindow(object):
    def setupUi(self, GeneratorMainWindow):
        ...
        GeneratorMainWindow.resize(693, 574)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 656, 125))
        ...
        self.horizontalLayout.addWidget(self.qp_code_line_edit)
